  ...
  <div class="space-y-6">
    ...
    <div id="report-content" class="card p-0 overflow-hidden min-h-[600px]">
      <div class="text-center px-6 pt-12 mb-12">
        <h2 class="text-xl font-bold uppercase tracking-widest text-on-surface">Accounts Receivable Aging</h2>
        ...
        <table class="standard-table">
          ...
          <tbody>
            <tr v-for="row in reportData.by_customer" :key="row.customer_name">
              <td class="whitespace-nowrap font-medium text-on-surface">{{ row.customer_name }}</td>

      ...
      <div v-else-if="reportData" class="max-w-3xl mx-auto space-y-12 mb-12">
        ...
        <section>
          ...
          <div class="space-y-4 px-4">
            <div class="space-y-2">
              <div
                v-for="item in reportData.assets"
            ...
            <div
              class="flex justify-between p-4 bg-background rounded-[10px] font-bold text-lg text-on-surface mt-6"
            >
        ...
        <section>
          ...
          <div class="space-y-8 px-4">
            ...
            <div>
              <h4
                class="font-bold text-muted mb-4 uppercase text-xs tracking-widest"
              >
                Liabilities
              </h4>
              <div class="space-y-2 pl-4">
                <div
                  v-for="item in reportData.liabilities"
                  :key="item.account_code"
                  class="flex justify-between"
                >
                  <span class="text-on-surface">{{ item.account_name }}</span>
                ...
                <div
                  class="flex justify-between pt-2 border-t border-divider font-bold text-on-surface mt-4"
                >
            ...
            <div>
              ...
              <div class="space-y-2 pl-4">
                <div
                  v-for="item in reportData.equity"
                  :key="item.account_code"
                  class="flex justify-between"
                >
                  <span class="text-on-surface">{{ item.account_name }}</span>
        ...
        <div
          ...
          "
          class="p-4 bg-error/10 text-error rounded-[10px] text-center font-bold no-print"
        >
...
const exportPDF = () => {
  reportService.exportToPDF(
    "report-content",
    `Balance-Sheet-${filters.date}.pdf`,
  );
};

    ...
    <form @submit.prevent="handleSubmit" class="card space-y-6">
      <div class="grid grid-cols-2 gap-6">
        <div class="form-group">
          ...
          />
          <p v-if="errors.code" class="text-error text-xs mt-2">
        ...
        <div class="form-group">
          ...
          />
          <p v-if="errors.name" class="text-error text-xs mt-2">
      ...
      <div class="grid grid-cols-2 gap-6">
        <div class="form-group">
          ...
          <p v-if="errors.type" class="text-error text-xs mt-2">
            {{ errors.type[0] || errors.type }}
          </p>
        </div>
        <div class="form-group">
          ...
          />
          <p v-if="errors.subtype" class="text-error text-xs mt-2">
            {{ errors.subtype[0] || errors.subtype }}
          </p>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <p v-if="errors.parent_id" class="text-error text-xs mt-2">
          {{ errors.parent_id[0] || errors.parent_id }}
        </p>
      </div>
...
const fetchAccount = async () => {
  ...
  try {
    ...
    const { code, name, type, subtype, parent_id, is_active, is_system } =
      response.data;
    form.value = {
      code,
      name,

<template>
  <div class="space-y-6">
    ...
    <div
      v-else-if="error"
      class="mx-4 p-4 rounded-lg bg-error/10 text-error font-bold"
      role="alert"
    >
      <p>Error: {{ error }}</p>
    </div>
    ...
    <div v-else class="space-y-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="card card-hover">
          <p
            class="text-[10px] font-bold text-muted uppercase tracking-widest mb-2"
          >
            Monthly Revenue
          </p>
        ...
        <div class="card card-hover">
          ...
          <p
            ...
            :class="metrics.net_income >= 0 ? 'text-primary' : 'text-error'"
          >
        ...
        <div class="card card-hover">
          ...
          <p class="text-2xl font-bold text-on-surface">
            ${{ formatCurrency(metrics.outstanding_ar) }}
          </p>
        </div>
        <div class="card card-hover">
          <p
          ...
          <p class="text-2xl font-bold text-on-surface">
            ${{ formatCurrency(metrics.outstanding_ap) }}
          </p>
        </div>
        <div class="card card-hover">
          <p
